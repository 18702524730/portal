		...
		<el-form label-position="left" ref="ruleForm" :rules="rules" :model="conForm" label-width="160px">
			...
			<div>
				<el-form-item label="企业名称(英文)" prop="name_en">
					<el-input v-model ="conForm.name_en" :maxlength="60" placeholder="请填写英文版企业名称，应与有效证件保持一致"></el-input>
				</el-form-item>
				<el-form-item label="企业名称(中文)" prop="apply_name">
					<el-input v-model ="conForm.apply_name" :maxlength="60" placeholder="请填写中文版企业名称"></el-input>
				</el-form-item>
				<el-form-item label="企业联系电话" prop="apply_phone">
					<el-input v-model="conForm.apply_phone" :maxlength="30" placeholder="请填写企业联系电话，电话前请加国家代码"></el-input>
				</el-form-item>
				...
				<el-form-item label="企业传真" prop="apply_fax">
					<el-input v-model="conForm.apply_fax" :maxlength="20" placeholder="请填写企业传真"></el-input>
				</el-form-item>
				...
				<el-form-item prop="address" style="margin-top:22px;">
					<el-input v-model="conForm.address" auto-complete="off" class="form-ipt" :maxlength="80" placeholder="请填写企业注册地址，与企业登记证件保持一致"></el-input>
				</el-form-item>
				<el-form-item label="邮编" prop="zip_code">
					<el-input v-model="conForm.zip_code" :maxlength="6" placeholder="请填写6位邮政编码"></el-input>
				</el-form-item>
				<el-form-item label="企业登记证件" prop="standby1">
				...
				<el-form-item label="企业登记证件译本" prop="standby2">
					<div class="upload_component">
	...
	data () {
		...
		return {
			...
			rules:{
				...
				standby1:[
					{ required: true, message: '请上传企业登记证件复印件，并加盖企业公章', trigger: 'change' }
				],
				standby2:[
					{ required: true, message: '请上传企业登记证件译本复印件，并加盖企业公章', trigger: 'change' }
				],
			}
		}
	},
