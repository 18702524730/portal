...
<style>
	/*dialog*/
	.xa-popup .layer{position:fixed;left:0;top:0;background:rgba(0,0,0,0.5);width:100%;height:100%;z-index:2000;}
	.xa-popup .popup{min-width:300px;background:#fff;z-index:2001;position:fixed;left:50%;top:50%;box-shadow:0 0 10px #888;border-radius: 2px;overflow:hidden;}
	.xa-popup .popup>.title{width:100%;height:56px;line-height:56px;text-align:center;font-size:16px;cursor:move;position:relative;}
	.xa-popup .popup>.title .name{padding-left: 20px;text-align: left;font-size: 14px;color: #333;}
	.xa-popup .popup>.title>.close{height:44px;width:44px;position:absolute;right:0;top:0;cursor:pointer;font-size:26px;color: #bbb;}
	.xa-popup .popup>.title>.close:after{content:'×';display:block;}
	.xa-popup .popup>.title>.close:hover{background:rgba(255,255,255,0.1);color: #999;}
